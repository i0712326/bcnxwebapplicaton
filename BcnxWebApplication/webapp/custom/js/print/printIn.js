$(document).ready(function(){
    ...
    var pRrn =localStorage.rrnIn;
    var pProc =localStorage.proccIn;
    var pSlot =localStorage.slotIn;
    var pStan =localStorage.stanIn;
    var pMti =localStorage.mtiIn;
    var pNewAmt = localStorage.newAmt;
    var pNewFee = localStorage.newFee;
    var pParam={"rrn":pRrn,"proc":pProc,"slot":pSlot,"stan":pStan,"mti":pMti};
